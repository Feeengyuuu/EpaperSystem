...
from .f1_domain import F1_SESSION_PREGAME_WINDOW, F1_SESSION_RESULT_WINDOW
...
EWC_DETAIL_LOW_MEMORY_SCAN_MAX_BYTES = 2 * 1024 * 1024
EWC_DETAIL_LOW_MEMORY_VALUE_MAX_BYTES = 1280 * 1024
