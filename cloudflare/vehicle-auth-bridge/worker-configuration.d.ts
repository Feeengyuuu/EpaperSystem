/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 13527f7e540b1dc4f568c100c3923d25)
// Runtime types generated with workerd@1.20260730.1 2026-08-05 nodejs_compat
interface __BaseEnv_Env {
	TESLA_AUDIENCE: "https://fleet-api.prd.na.vn.cloud.tesla.com";
	TESLA_APP_DOMAIN: "epaper-vehicle-bridge.superxfy.workers.dev";
	TESLA_REDIRECT_URI: "https://epaper-vehicle-bridge.superxfy.workers.dev/oauth/callback";
	TESLA_OAUTH_SCOPES: "openid offline_access vehicle_device_data vehicle_location";
	OAUTH_LAUNCH_TTL_SECONDS: "120";
	OAUTH_SESSION_TTL_SECONDS: "600";
	VEHICLE_SUMMARY_TTL_SECONDS: "900";
	VEHICLE_SUMMARY_MAX_STALE_SECONDS: "86400";
	TESLA_CLIENT_ID: string;
	TESLA_CLIENT_SECRET: string;
	BRIDGE_ADMIN_TOKEN: string;
	BRIDGE_READ_TOKEN: string;
	TOKEN_ENCRYPTION_KEY_V1: string;
	VEHICLE_AUTH: DurableObjectNamespace<import("./src/index").VehicleAuthState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VehicleAuthState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TESLA_AUDIENCE" | "TESLA_APP_DOMAIN" | "TESLA_REDIRECT_URI" | "TESLA_OAUTH_SCOPES" | "OAUTH_LAUNCH_TTL_SECONDS" | "OAUTH_SESSION_TTL_SECONDS" | "VEHICLE_SUMMARY_TTL_SECONDS" | "VEHICLE_SUMMARY_MAX_STALE_SECONDS" | "TESLA_CLIENT_ID" | "TESLA_CLIENT_SECRET" | "BRIDGE_ADMIN_TOKEN" | "BRIDGE_READ_TOKEN" | "TOKEN_ENCRYPTION_KEY_V1">> {}
}
