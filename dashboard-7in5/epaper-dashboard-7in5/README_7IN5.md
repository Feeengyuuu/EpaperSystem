...
```powershell
cd G:\PersonalProjects\EpaperSystem\dashboard-7in5\epaper-dashboard-7in5
...
```text
G:\PersonalProjects\EpaperSystem\dashboard-7in5\epaper-dashboard-7in5\output\dashboard-7in5-preview.png
G:\PersonalProjects\EpaperSystem\dashboard-7in5\epaper-dashboard-7in5\output\dashboard-7in5-display.bmp
G:\PersonalProjects\EpaperSystem\dashboard-7in5\epaper-dashboard-7in5\output\dashboard-10in85-source.png
```
